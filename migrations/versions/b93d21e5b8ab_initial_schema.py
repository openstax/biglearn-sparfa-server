...
Revision ID: b93d21e5b8ab
Revises:
Create Date: 2018-10-18 16:40:41.360584
...
def upgrade():
    ...
    op.create_index('ix_pages_page_uuid_ecosystem_uuid', 'pages', ['page_uuid', 'ecosystem_uuid'], unique=True)
...
def downgrade():
    ...
    op.drop_index('ix_pages_page_uuid_ecosystem_uuid', table_name='pages')
    op.drop_table('pages')
